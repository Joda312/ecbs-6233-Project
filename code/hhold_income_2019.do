...
use "../data/raw/2019/hh5a.dta", clear

collapse (sum) income=h502, by(hhid)
replace income=12*income
merge 1:1 hhid using "../data/derived/tot_assets_2019.dta"
keep if _merge==3
drop _merge
*replace income=tot_assets+income
*drop tot_assets _merge
save "../data/derived/hhold_income_2019.dta", replace

use "../data/raw/2019/hh5b", clear
