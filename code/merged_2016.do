...
use "../data/derived/hhold_comp_2016.dta", clear
sort hhid, stable
...
merge 1:1 hhid using "../data/derived/oblast_2016.dta"
keep if _merge==3
drop _merge

merge 1:1 hhid using "../data/derived/savings_credit_2016.dta"
keep if _merge==3
drop _merge

merge 1:1 hhid using "../data/derived/remittances_2016.dta"
drop if _merge==2
...
save "../data/derived/merged_2016.dta", replace