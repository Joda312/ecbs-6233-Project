...
use "../data/derived/hhold_comp_2019.dta", clear
sort hhid, stable

merge 1:1 hhid using "../data/derived/hhold_income_2019.dta"
keep if _merge==3
drop _merge

merge 1:1 hhid using "../data/derived/oblast_2019.dta"
keep if _merge==3
drop _merge

merge 1:1 hhid using "../data/derived/savings_credit_2019.dta"
keep if _merge==3
drop _merge

merge 1:1 hhid using "../data/derived/remittances_2019.dta"
drop if _merge==2
...
save "../data/derived/merged_2019.dta", replace